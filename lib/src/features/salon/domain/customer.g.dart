...
void _customerSerialize(
  ...
  writer.writeDateTime(offsets[0], object.lastVisit);
...
Customer _customerDeserialize(
  ...
  object.id = id;
  object.lastVisit = reader.readDateTimeOrNull(offsets[0]);
  object.name = reader.readString(offsets[1]);
  object.phoneNumber = reader.readStringOrNull(offsets[2]);
  object.totalDebt = reader.readDouble(offsets[3]);
  return object;
}
...
extension CustomerQueryFilter
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> lastVisitIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> lastVisitIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> lastVisitEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastVisit',
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> lastVisitGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> lastVisitLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> lastVisitBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CustomerQuerySortBy on QueryBuilder<Customer, Customer, QSortBy> {
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByLastVisit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastVisit', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByLastVisitDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQuerySortThenBy
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByLastVisit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastVisit', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByLastVisitDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastVisit', Sort.desc);
    });
  }
...
extension CustomerQueryWhereDistinct
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByLastVisit() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQueryProperty
  ...
  QueryBuilder<Customer, DateTime?, QQueryOperations> lastVisitProperty() {
    return QueryBuilder.apply(this, (query) {
